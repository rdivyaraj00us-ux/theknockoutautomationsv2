...
const Starter = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <SEO
        title="900+ n8n Starter Pack — $9.99 | The Knockout Automations"
        description="900+ hand-picked n8n workflow templates for $9.99. Instant download, lifetime access, 30-day money-back guarantee."
        canonical="https://theknockoutautomations.com/starter"
        product={{
          price: "9.99",
          priceCurrency: "USD",
          ...
          description:
            "900+ hand-picked n8n workflow templates. Instant download, lifetime access.",
          brand: "The Knockout Automations",

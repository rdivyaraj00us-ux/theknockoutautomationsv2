...
const GuaranteeSection = () => (
  <section className="py-20 sm:py-28 px-4 bg-gradient-section">
    <div className="max-w-3xl mx-auto text-center reveal">
      <div className="rounded-2xl border border-[hsl(var(--gold))]/30 bg-[hsl(var(--gold))]/5 p-8 sm:p-12">
        <div className="flex justify-center mb-6">
          <MoneyBackSeal size={120} />
        </div>
        <h2 className="text-3xl sm:text-4xl font-black mb-4">
          30-Day <span className="text-[hsl(var(--gold))]">Money-Back</span> Guarantee
        </h2>
